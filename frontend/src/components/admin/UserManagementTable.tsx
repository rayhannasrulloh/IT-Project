  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center pb-2 border-b border-border">
        <div>
          <h3 className="text-base font-semibold text-foreground">System Profiles</h3>
              ...
              users.map((profile) => (
                <TableRow key={profile.id} className="border-border/60">
                  <TableCell className="py-3 flex items-center space-x-2 text-xs text-foreground">
                    <div className="h-7 w-7 rounded-full bg-card border border-border flex items-center justify-center">
                  ...
                  <TableCell className="py-3">
                    {profile.role === 'admin' ? (
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-semibold bg-card text-muted-foreground border border-border/80">
                  ...
                  <TableCell className="py-3 text-right">
                    <Button
                      ...
                      className="text-xs px-2.5 py-1.5 border-border hover:bg-card font-semibold"
                    >
