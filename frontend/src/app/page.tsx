    ...
    <div className="relative min-h-screen bg-[#FAFAFA] dark:bg-[#151414] text-[#0F172A] dark:text-[#F9FAFB] overflow-x-hidden">
      ...
      <header className="relative w-full z-30 border-slate-200/40 dark:border-slate-800/30 backdrop-blur-sm bg-[#FAFAFA]/60 dark:bg-[#151414]/60">
        <nav className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium dark:text-white">
            <a href="#about" className="hover:text-[#FF5F08] transition-colors duration-200">About</a>
            <a href="#how" className="hover:text-[#FF5F08] transition-colors duration-200">How it works</a>
          </div>

          <div className="hidden md:flex items-center gap-4">
            <button
              onClick={toggleTheme}
              className="h-9 w-9 rounded-full border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-900 transition-colors flex items-center justify-center cursor-pointer"
          ...
          <div className="flex items-center gap-2.5 md:hidden">
            <button onClick={toggleTheme} className="h-9 w-9 rounded-full border border-slate-200 dark:border-slate-800 flex items-center justify-center cursor-pointer">
              {theme === 'dark' ? <SunIcon className="h-4 w-4 text-yellow-400" /> : <MoonIcon className="h-4 w-4 text-slate-600" />}
            </button>
            <button
              onClick={() => setIsOpen(!isOpen)}
              className="h-9 w-9 rounded-full border border-slate-200 dark:border-slate-800 flex items-center justify-center z-50 relative cursor-pointer"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-x-0 top-16 bg-[#FAFAFA]/95 dark:bg-[#151414]/95 backdrop-blur-md border-b border-slate-200 dark:border-slate-800 shadow-lg md:hidden z-40 p-6 flex flex-col gap-4"
          >
            <a href="#about" onClick={() => setIsOpen(false)} className="text-base font-medium text-slate-600 dark:text-[#F0E3DE] hover:text-[#FF5F08]">About</a>
            <a href="#how" onClick={() => setIsOpen(false)} className="text-base font-medium text-slate-600 dark:text-[#F0E3DE] hover:text-[#FF5F08]">How it works</a>
      ...
      <section className="relative pt-24 pb-16 text-center flex flex-col items-center max-w-4xl mx-auto px-6 z-10">
        ...
        <motion.h1
          ...
          className="text-5xl md:text-6xl font-semibold tracking-tight text-[#FF5F08] mt-5 leading-[1.1]"
        >
        ...
        <motion.p
          ...
          className="mt-6 dark:text-[#F0E3DE] max-w-2xl text-base md:text-lg leading-relaxed dark:[text-shadow:0_1px_16px_rgba(0,0,0,1),0_0_32px_rgba(0,0,0,0.8)]"
        >
      ...
      <section id="about" className="relative max-w-6xl mx-auto px-6 py-16 z-10">
        <div className="text-center mb-12">
          ...
          <p className="mt-2 text-sm md:text-base text-slate-500 dark:text-[#F0E3DE]">
      ...
      <section className="relative max-w-4xl mx-auto px-6 py-16 z-10">
        ...
        >
          ...
          <p className="mt-3 text-sm text-slate-500 dark:text-[#F0E3DE] max-w-xl mx-auto leading-relaxed">
      ...
      <footer className="relative w-full z-10 mt-12 border-t border-slate-200 dark:border-slate-800/80">
        <div className="max-w-6xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between text-xs text-slate-500 dark:text-[#F0E3DE] gap-4">
